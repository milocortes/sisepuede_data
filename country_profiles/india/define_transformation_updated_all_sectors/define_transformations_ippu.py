...
class TransformationsIPPU:
    ...
    def transformation_ippu_reduce_hfcs(self,
        ...
        df_out = tbi.transformation_ippu_scale_emission_factor(
            df_input,
            {"hfc": 0.9}, # applies to all HFC emission factors
            self.vec_implementation_ramp,
            self.model_attributes,
            field_region = self.key_region,
            model_ippu = self.model_ippu,
    ...
    def transformation_ippu_reduce_n2o(self,
        ...
        df_out = tbi.transformation_ippu_scale_emission_factor(
            df_input,
            {
                self.model_ippu.modvar_ippu_ef_n2o_per_gdp_process : 0.99,
                self.model_ippu.modvar_ippu_ef_n2o_per_prod_process : 0.99,
            },
            self.vec_implementation_ramp,
            self.model_attributes,
            field_region = self.key_region,
    ...
    def transformation_ippu_reduce_other_fcs(self,
        ...
        df_out = tbi.transformation_ippu_scale_emission_factor(
            df_input,
            {"other_fc": 0.99}, # applies to all Other Fluorinated Compound emission factors
            self.vec_implementation_ramp,
            self.model_attributes,
            field_region = self.key_region,
            model_ippu = self.model_ippu,
    ...
    def transformation_ippu_reduce_pfcs(self,
        ...
        df_out = tbi.transformation_ippu_scale_emission_factor(
            df_input,
            {"pfc": 0.99}, # applies to all PFC emission factors
            self.vec_implementation_ramp,
            self.model_attributes,
            field_region = self.key_region,
            model_ippu = self.model_ippu,

...
for estrategia_id, datos_estrategias in estrategias.items():
    ...
    if pij_to_stress:
        ...
        if "pij_lndu_other_to_other" in list(df_pij_to_stress.columns):
            ...
            states_factors["pij_lndu_other"].update({'pij_lndu_other_to_forests_primary': 1.1, 
                                                'pij_lndu_other_to_forests_secondary': 0.5, 
                                                'pij_lndu_other_to_grasslands': 1.2})

        for state in states:
            for state_group in states_groups[state]:
                df_pij_to_stress[state_group] *= states_factors[state][state_group]  

        #df_pij_to_stress["pij_lndu_forests_secondary_to_forests_secondary"] *=0.1
        ...
        if "pij_lndu_other_to_other" in list(df_pij_to_stress.columns):
            ...
            df_pij_to_stress["pij_lndu_other_to_other"] *=0.6

...
variable_to_process = "Oil products"
sisepuede_name = "exports_enfu_pj_fuel_oil"
...
wbal_var_to_proc[variable_to_process] = wbal_var_to_proc[variable_to_process].replace(-0.0, 0.0)
...
asumptions_exports_factors = {
    ...
    "Oil products" : 0.05 # Assumption export 0.39 of export Oil products go to electricity production
}

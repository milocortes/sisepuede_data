...
historical_path = os.path.join(sources_path,"frac_inen_sisepuede_industry_fuels_data.csv")
...
## Load projected data
projected_path = os.path.join(sources_path,"frac_inen_sisepuede_industry_fuels_data_projected.csv")

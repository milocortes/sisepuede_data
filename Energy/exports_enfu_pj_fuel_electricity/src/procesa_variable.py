...
variable_to_process = "Electricity"
sisepuede_name = "exports_enfu_pj_fuel_electricity"
...
# Assumption export 1 of export Electricity go to Electricity production
...
last_one_year = max(wbal_var_to_proc_all["Year"]) - 1

...
## Convert Km/100km  unit to sisepuede unit km/l [ km/l = ((LGE/100km)^-1)(1/100)  ]
## 1 Kg. of CNG is energy equivalent to 1.39 liters of petrol and 1.18 liters of diesel. (https://transport.delhi.gov.in/content/alternate-fuel-control-pollution-compressed-natural-gas-cng#:~:text=1%20Kg.,8%2F9%2F10%20Kg.)

for k,v in historical_assumption.items():
    historical_assumption[k] = ((v*1.19)**-1)*100

for k,v in projected_assumption.items():
    projected_assumption[k] = ((v*1.19)**-1)*100

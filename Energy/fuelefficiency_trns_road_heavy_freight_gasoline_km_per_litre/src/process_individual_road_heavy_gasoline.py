...
## Rename columns
var_sisepuede = "fuelefficiency_trns_road_heavy_freight_gasoline_km_per_litre"
...
### ASSUMPTION : gasoline is 50% less efficient than diesel
all_historical_df[var_sisepuede] = all_historical_df[var_sisepuede].apply(lambda x: ((x*1.5)**(-1)*100))
